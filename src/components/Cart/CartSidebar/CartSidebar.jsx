          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className={styles.cartSidebar__summary}>
                ...
                {/* Promo code */}
                <div className={styles.cartSidebar__promo}>
                  <div className={styles.cartSidebar__promoInputGroup}>
                    <input
                      type="text"
                      placeholder="Código promocional"
                      className={styles.cartSidebar__promoInput}
                    />
                    <button className={styles.cartSidebar__promoButton}>
                      Aplicar
                    </button>
                  </div>
                  <p className={styles.cartSidebar__promoNote}>
